    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <button onClick={() => navigate('/')} className="flex items-center font-playfair text-white text-3xl font-bold">
            <Home className="mr-2" />
            DreamHome
          </button>
          ...
          <ul className="hidden md:flex space-x-6 items-center">
            ...
            <li>
              <button onClick={() => navigate('/register')} className="bg-accent-gold text-white font-semibold px-5 py-2 rounded-full hover:bg-white hover:text-primary-navy transition-all duration-300 hover:-translate-y-0.5">
                Register
              </button>
            </li>
              ...
              {profileDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-100 py-2 z-50">
                  <div className="px-4 py-2 border-b border-gray-100">
                    ...
                    <p className="text-xs text-text-light">john.doe@example.com</p>
                  </div>
